...
function Compress_Parallel_Divided_Input(option_input,search_buffer_length,no_of_chunks)
    ...
    if (option==1)
        output=open("Compressed_Parallel_Divided_Input1.txt", "w")
        ...
        @threads for i in 1:no_of_chunks
            ...
            Collected_Results_Upper_bits_of_Numbers[i], Collected_Results_offset_lower_8bits[i], Collected_Results_max_match_length_lower_8bits[i], Collected_Results_following_character[i], Lengths_of_Compressed_Chunks[i] = Compress_Parallel_Divided_Input_Core(input[chunk_start_index:chunk_end_index], option, search_buffer_length, look_ahead_buffer_length, chunk_start_index)
        end
        ...
        close(output)
    elseif (option==2)
        output=open("Compressed_Parallel_Divided_Input2.txt", "w")
        ...
        @threads for i in 1:no_of_chunks
            ...
            Collected_Results_offset[i], Collected_Results_max_match_length[i], Collected_Results_following_character[i], Lengths_of_Compressed_Chunks[i] =Compress_Parallel_Divided_Input_Core(input[chunk_start_index:chunk_end_index], option, search_buffer_length, look_ahead_buffer_length, chunk_start_index)
        end
...
function Compress_Parallel_Divided_Input_Core(input, option_input, search_buffer_length, look_ahead_buffer_length, start_target)#(input,option)
...
# println("\nCPU Parallel_Divided_Input search_buffer_length-4075")
@btime Compress_Parallel_Divided_Input(1,4075,Threads.nthreads())
# @btime Compress_Parallel_Divided_Input(1,4075,4)
# @btime Compress_Parallel_Divided_Input(1,4075,6)
# @btime Compress_Parallel_Divided_Input(1,4075,6)
@btime Compress_Parallel_Divided_Input(2,65000,Threads.nthreads())


# @btime Compress_Parallel_Divided_Input(2,65000,2)
# @btime Compress_Parallel_Divided_Input(1,4075,6)
# @btime Compress_Parallel_Divided_Input(1,4075,8)
# @btime Compress_Parallel_Divided_Input(1,4075,12)
